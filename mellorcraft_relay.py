#!/usr/bin/env python3
"""MellorCraft v1.6.1 singleplayer LAN relay.
...
async def main() -> None:
    parser = argparse.ArgumentParser(description="MellorCraft v1.6.1 singleplayer LAN relay")
    parser.add_argument("--port", type=int, default=DEFAULT_PORT, help="WebSocket relay port (default: 8000)")
    args = parser.parse_args()
    print("MellorCraft v1.6.1 Singleplayer LAN Relay")
